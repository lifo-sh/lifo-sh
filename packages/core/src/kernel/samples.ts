...
Explore these files to learn shell scripting and Lifo features.
...
if [ "$name" = "lifo" ]; then echo "  name equals lifo"; fi
...
console.log("Hello from Node.js on Lifo!");
...
// Demonstrates Node.js fs operations on the Lifo VFS
